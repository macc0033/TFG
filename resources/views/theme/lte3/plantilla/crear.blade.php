    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                ...
                <form action="{{route('guardar_plantilla')}}" id="form-general" class="form-horizontal" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Crear Plantilla</h3>
